...
<div class="msr-location">
    <p><span><b>Location:</b> The beach near Yumenosaki Academy</span></p>
</div>
...
<th>(W-W-Wh…*What!?* A rock almost flew straight at me outta nowhere!? Did a rock bounce up while we were running on the sand…?)</th>
{% endbubble %}

{% bubble Tetora angry %}
<th>(No— I definitely felt hostility from that.)</th>

<th>(Someone just tried to attack us…!?)</th>
{% endbubble %}
...
You may have the look of a tamed pet, but your true nature really <em>is</em> that of a beast after all, huh?[^10]

Why, I could’ve sliced your head off if that kick hit.
{% endbubble %}

{% bubble Tetora angry %}
<th>(This guy…! He tried to throw me off guard so he could catch me by surprise with an upper roundhouse kick!?)</th>

<th>(He’s got insane power…! I only got a li’l grazed, but my cheek looks like it got burned…!)</th>
{% endbubble %}

{% bubble Hiiro glare %}
…Did you not just mention how you’re also an idol who shouldn’t engage in violence, <em>and</em> that you wouldn’t take revenge as it’s too old-fashioned?
{% endbubble %}
...
Even if those acts aren’t appropriate for idols, I <em>will</em> beat up any villain that hurls sneak attacks at people.
{% endbubble %}
...
So bye-byeee~…♪ *<th>(waves)</th>*
{% endbubble %}

<div class="msr-narration">
    <p>Sound of water splashing</p>
</div>
...
{% bubble Tetora frown %}
Ossu. …The heck <em>was</em> that, seriously…
{% endbubble %}

{% bubble Hiiro northinking %}
