...
{% img Climax Epilogue 1.png %}

{% bubble Eichi %}
Anzu-chan, the moon is pretty tonight, isn’t it?

Hehe, looks like it’ll be a while until the sun is up.
...
I wonder what kind of repayment those kids will give Wataru and me… and to the other seniors who’ll be leaving.

Hehe, of course you, as the producer, know exactly what *fine* will be doing in the second half.

“Don’t tell me! I’ll imagine it myself!”

That was my attempt at Tsukinaga-kun. I’d prefer it if you didn’t take away the blissful moments of gazing at a present and imagining what could be inside of it.

…Anzu-chan?

Oh my, I was wondering why you weren’t responding. You’ve fallen asleep.

It did seem like a lot of hard work for you once again… You struggled to do a lot of things for many units.
...
Hehe, but at the very least, you should relax and rest up until that happy moment begins.

I’ll carefully carry you bridal style, so that you don’t shake about as we get there. This is my White Day gift to you.

Aah… For once in a long time, I feel like I can sleep soundly tonight with no worries at all.
...
{% bubble Eichi %}
Shhh… You really don't pay attention to these things, do you? Anzu-chan is sleeping, so I'd prefer it if you stayed quiet.
{% endbubble %}

{% bubble Subaru %}
Woah-- Sorry. Wait, why are you carrying Anzu? You two are on good terms?
{% endbubble %}

{% bubble Eichi %}
Yes. Well, I want to think we’re at least able to be friends.

Hehe. You know, for once it seems like Keito is going all-out in this event.

So the student council's duties were delayed a bit, and Anzu-chan and I tried to finish up the rest of it. Because of that, we were in the student council room, you see?
...
Hehe, we’ll obviously get cold if we keep standing around and talking in a place like this. Let's each head off to where we should be before we catch a cold.
{% endbubble %}
...
{% bubble Eichi %}
Of course. All these days I spent were shining and glittering more than a jewel ever could.

I'm sure the rest of you students will also get to enjoy a bright, youthful life, just as I did—perhaps even more.
...
White Day is different from Valentine‘s Day. The gift you give is likely to make the person happy in the end anyway, but it doesn't change the fact that it makes you nervous.

Hehe, well then, see you later. It’s a shame, but it’s time to part.
...
Heheh, but Chi~chan-senpai’s number one favorite is probably Takamin.

It really *is* frustrating that Takamin gets to steal all his attention, and it looks like he’s gonna become the hero Chi~chan-senpai hoped for…

Maybe I should become the idol Chi~chan-senpai hoped for.
...
{% bubble Eichi %}
Me too, Subaru-kun. Ahh, doesn’t it make you feel glad to be born?
{% endbubble %}
...
{% img Climax Epilogue 2.png %}

{% bubble Kaoru %}
Kanata-kuuun! Moricchi~!

Over here, over here! Come on, it looks like Ryusetai’s up next~♪
{% endbubble %}
...
{% bubble Kaoru %}
Huh?! Why are you so observant sometimes?! You’re usually a thickheaded alien, you know?!

I confessed to Anzu-chan knowing I’d be rejected, and lo and behold, I was~! So let me off this time, alright?!
{% endbubble %}
...
{% bubble Kaoru %}
Yeah, Sakuma-san also said something like that~ Just what I’d expect from an oddball—You guys have similar ways of comforting people, after all.
{% endbubble %}

{% bubble Kanata v2 %}
Hehe. Kaoru, you will work as an idol with Rei from here on out, right? I am cheering you on.
{% endbubble %}
...
{% bubble Kanata v2 %}
Hehe, for you of all people to be pushing yourself… But thank you.
{% endbubble %}

{% bubble Kaoru %}
You don’t have to thank me. You’re my friend, you know?
{% endbubble %}
...
{% bubble Kaoru %}
Yeah. There was one point when it was awkward, but I think it looks okay for now.
...
Heheh, Souma-kun is a real goody boy. If he can’t be happy, nobody can.
...
{% bubble Kanata v2 %}
Hehe, good job, Kaoru. Goood boy, goooood boy…~♪
{% endbubble %}
...
{% bubble Chiaki v2 %}
Ah no, I just thought it’d be rude to interrupt. Even I read the mood sometimes, Kanata.
{% endbubble %}
...
{% bubble Chiaki v2 %}
Gwah?! Wha-- Why did you charge at me, my comrades?! Were you brainwashed by the enemy?!
{% endbubble %}

{% bubble Tetora v2 %}
What “enemy”… You’re late! We were worried you wouldn’t even come, y'know?! Just what took you so long?!
{% endbubble %}
...
Fuhaha! Worry not, Takamine! The greengrocer shop is also thriving! ☆
{% endbubble %}

{% bubble Midori %}
Uugh, there you go again with doing needless--… You’re always like this…
...
That aside! There are no problems over on that side, so you can enjoy yourselves in the live without any worry!

We’ll be watching you from the audience! Watching over your lives that inherited the heart of justice…!

Aahh, just seeing your majestic selves makes me feel like I'm about to burst into tears!

Do your best, Ryuseitai, do your best!! Don’t lose now, Ryuseitai, do your best!!!
{% endbubble %}

## Chapter 3

{% img Climax Epilogue 3.png %}
...
<th>(Hehehe. For a while there, I was unsure how this would go, but either way we may be able to get through Repayment Festival to the very end.)</th>
...
<th>(Midori-kun arrived pretty late, and we decided to leave the talking for later and just do our best for now…)</th>

<th>(We quickly rehearsed together and rushed everything up until this point. With how much of a mess it has been, it is truly a miracle we managed to get past the first part.)</th>

<th>(Of course, that is only how we feel about it mentally. Our actual performance has been going fine.)</th>

<th>(We have grown. No, actually, with everyone’s strength combined, we managed to get through many hardships…)</th>

<th>(Those hardships united us as allies with a bond stronger than friends or family. They have helped us hone ourselves with every dance step, every song…)</th>

<th>(Whenever I remember all of that, I start to really feel like we have changed.)</th>

<th>(So maybe, we'll be okay. No, I'm sure of it.)</th>

<th>(At least, that’s what *I* am going to keep on believing.)</th>[^1]

<th>(This isn't our last time or anything.)</th>
{% endbubble %}

{% bubble Tetora v2 %}
<th>(…Ahaha, Shinobu-kun has a serious look on his face, that’s unusual.)</th>

<th>(That’s how much we’re on his mind, I bet. He’s so concerned about us that he can’t even mess around.)</th>

<th>(Shinobu-kun’s looks are surprisingly dignified. Manly, even.)</th>

<th>(If he wore stylish clothes and pulled his hair up like how his beloved Isara-senpai does… He would possess looks good enough to be a proper idol.)</th>
...
<th>(Isn't he awesome? I admire that about him so much.)</th>

<th>(I don’t know if someone hollow like me… is even qualified to lead guys as cool as Shinobu-kun and Midori-kun…)</th>

<th>(But I’ve been asked to take up this position. For the first time in my life, I’ve been tasked with something that “can only be given to me.”)</th>

<th>(So I’m going to take risks and devote my whole self to this.)</th>

<th>(I’m clumsy, so I can’t do things right at all.)</th>

<th>(It won't go as well as it did for Taichou or Taishou or a hero from a tokusatsu, nor will it go like I'm a protagonist from a story.)</th>

<th>(But! No matter how much I fail, no matter how muddy I get, no matter how loudly I cry… I won’t run away anymore. I’ll stand firm.)</th>

<th>(A loss isn’t a loss if you refuse to accept defeat to the very end.)</th>

<th>(Even if no one cares about me anymore, even if I become hated, and the people around me leave…)</th>

<th>(At least I, as part of Ryuseitai, will stand my ground with the legacy of my seniors.)</th>

<th>(Even if the only thing I can do is to stand tall. Just like what Taishou told me about how Taichou was in the past… I’ll keep fighting without giving up.)</th>

<th>(Even if people laugh at me and say I’m incompetent, I’m sure at least Midori-kun and Shinobu-kun would accept me for who I am. They’ll come rushing to me, picking me back up when I’m about to fall.)</th>
...
<th>(Of course, it’s still scary, but I shouldn’t run away because of that. That’s not what it means to be a hero…)</th>

<th>(Yeah, that’s right, I wanna be a hero too.)</th>

<th>(I wanna be cool; a man among men. Even if it’s difficult for me right now, one day, I’ll surely…)</th>
{% endbubble %}
...
We’re in the middle of our performance, talking isn’t allowed.
{% endbubble %}

{% bubble Midori %}
Haha, there you go again, sounding like you’re a leader~♪
{% endbubble %}

{% bubble Tetora v2 %}
Do you have some kind of complaint about that? Ah, could it be that you wanted to be the next “Ryusei Red” or something?
...
I mean, I’ve always been this way… I’ve never really had a fight with someone before because I’d always run away before it could have happened…

So I’m not really used to this, I feel conflicted, and a lot feels wrong…
...
{% img Climax Epilogue 4.png %}

{% bubble Midori %}
Actually, even if I did try to run away—Morisawa-senpai, Shinkai-senpai, or Anzu-san…

Someone will interfere and grab me by the neck, saying “Come over here already,” and pull me back to the problems I should face head-on…
...
But I love you all, I want to be together with you all… Someone like me may just be a huge eyesore, but I want to stay by everyone’s side…

I told you that you’re neither my family nor my relatives, but I want to amend that…

People who’d get that angry just for my sake—even if they aren’t my family—are people I should treasure just like family, or even more so…
...
So please, let me be by your sides. Even if this is only a dream, I don’t want to wake up from it yet.
{% endbubble %}
...
{% bubble Tetora v2 %}
Wha-?! Sorry, back then I wasn’t thinking straight and ended up saying something I didn’t mean!
{% endbubble %}
...
{% bubble Tetora v2 %}
Wha… Huh? Taichou? Shinkai-senpai?

W-Why are you two getting on the stage? And you’re even wearing clothes that match our outfits for Repayment Festival…!
{% endbubble %}

{% bubble Chiaki v2 %}
Is there a problem? We’re also Ryuseitai, at least for now!

Heheh. Takamine said something particularly interesting, so when I asked Anzu about it…

Well, first I gave her something for White Day. And then, it seemed like she had already prepared outfits for us, too…

Apparently it was her who sewed Ryuseitai's outfits this time, and while making them she thought, “It'll probably be the five of them on stage like always.”
...
In any case, there’s outfits for us too, so it’d be a waste not to wear them, wouldn’t it?

And besides, this may be the last chance for the five of us to be on stage together.

It'll be the last memory we make together, but if you tell me I’m in your way, then I'll step back.

But I *really* just can’t sit back and watch anymore!

Ahhh, it was pretty rough for me this time around! I wanted to say something, to do something!
...
Hehehe, but it was also rough for me to only be watching.

I am relieved. You three will be alright even if we are not here. You will be able to storm any weather.
...
And even our audience would want it to be the five of us together as Ryuseitai.
...
Us three won’t be able to fill the leading roles by ourselves just yet, so I’ll gratefully let our seniors interfere, just this once.

It’s a blessing to know we’re not fighting alone, after all.

But you know, you two were meant to be our audience…
...
{% bubble Kanata v2 %}
That’s right~ There is no need to say trivial things. Instead, focus on what you must do.

Let's get our audience excited as we always do… together~♪

Now then, everyone, let's begin from what we all know… what we always promise to do.
{% endbubble %}

## Chapter 5

{% img Climax Epilogue 5.png %}

{% bubble Kanata v2 %}
Hello! We are Ryuseitai! Thank you for coming over to see our live~♪

All of you probably know who we are, but this is what we always promise to do, sooo… First we will begin with our introductions.
...
{% bubble Kanata v2 %}
Hehehe, I am sorry for taking your forte, Shinobu~♪
{% endbubble %}

{% bubble Shinobu v2 %}
No problem at all! To be a ninja is to take three steps back and stay behind others as their shadow.

But even so, I do not want to be forgotten.
{% endbubble %}

{% img /img/es/eventstory/climax/shinobubcg.jpg %}

{% bubble Shinobu v2 %}
Actually… So that I am not forgotten, so that people will not say they do not even know whether I am here or not… I, too, will loudly and magnificently introduce myself.
...
{% bubble Tetora v2 %}
Errm… I had a plan for how we were gonna do this, though… Now that everyone’s just doing as they please, it’ll be tough to get everything back on track.

But that *is* the usual for us anyway.

I don’t know if I can do things properly like Taichou… but I’m gonna burn the flames of justice I inherited to their limit and do my absolute best.
{% endbubble %}

{% img /img/es/eventstory/climax/tetorabcg.jpg %}

{% bubble Tetora v2 %}
As a member of Ryuseitai—No… As the next Taichou who will lead Ryuseitai, I’m gonna shine bright like the sun. Today, tomorrow, and forever onward. I’ll burn a bright red.
...
If anyone can do it, it’s you. Black absorbs all light, and you can now take all of that stored up energy and let it explode as you please.

I'm sure *you* will be able to use that strength properly.

<th>(…Woops. I shouldn’t be fascinated right now, I have to introduce myself, too.)</th>

<th>(I’m no longer a kid whose eyes glisten as he watches heroes being heroes, because I’ve become the hero I've always longed to be.)</th>

<th>(Heheh~♪ Time to say it with the loudest voice and the bestest smile in history!)</th>

The red flames are—Gwah?!
{% endbubble %}
...
You may have always been annoying, suffocating, clingy, gross, noisy, unpleasant, troublesome, and really gross, but--
{% endbubble %}
...
And, well… Let’s just call it even.

All the kindness you’ve given me—Even if I spent my whole life trying, I don’t think I could ever fully return the favor. But at the very least, I want to prove that your year didn't go to waste.

Thanks to you, even I’ve changed a little… and I'll show that to you now.

When we first met, you asked me, "Won't you be a hero?"
...
The green flames are the mark of compassion, the great nature that grows infinitely!

Ryusei Green, Takamine Midori…!
{% endbubble %}
...
<th>(Ahaha… No good, I really didn't want to cry until after graduation, at least not in front of the kids… But I'm reaching my limit.)</th>
{% endbubble %}

{% bubble Midori %}
Hey… This isn't the time to be crying, please finish what you have to do. Please do your usual catchphrase.

Please shine in your own way, as you always have — in everyone's center.

I didn't dislike seeing that at all… Morisawa-senpai.
{% endbubble %}

{% bubble Chiaki v2 %}
I see, so that’s how it was. That’s good, I’m glad. Ahh, I’m so glad.
...
Then there’s meaning to the desperate fight it took to reach here.
{% endbubble %}
...
## Translation Notes
[^1]: He says *boku* here for “I” instead of *sessha* (the typical way Shinobu talks as a ninja), and doesn't end his line with *de gozaru*.
