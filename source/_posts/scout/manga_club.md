...
<div class="msr-location">
    <p><span><b>Location:</b> Street</span></p>
</div>
...
Why’s this the one day I forget to set my alarm!? I’m <em>never</em> the type to make this sorta mistake…!

And we <em>just</em> started our week to reduce late arrivals! What’s the point if the Student Council President himself is late!?
...
{% img /img/es/scoutstory/mangaclub/1_2.jpg %}
...
{% bubble Keito %}
Incorrigible. Why on <em>earth</em> were you running here!? You have to look before you turn!
{% endbubble %}

{% bubble Mao %}
I’m very sorry about that, I really am… And I know I’m being rude talking like this to a senior, but please let me ask again… <em>What</em> are you doing…?
{% endbubble %}
...
{% bubble Mao %}
Umm… But I’m asking you <em>because</em> it isn’t obvious…?
{% endbubble %}

{% bubble Keito %}
<em>Sigh</em>… Very well then, I’ll explain it to you.
...
{% img /img/es/scoutstory/mangaclub/1_3.jpg %}
...
{% bubble Mao %}
Mm… What <em>was</em> that? How do I even begin to explain what I saw…
{% endbubble %}
...
<th>(…Huh? Wait, has Sagami-sensei always been our homeroom teacher this year…?)</th>

<th>(Well, whatever. If he’s here, it obviously means he’s the homeroom teacher, so…)</th>

<th>(Hmm… It feels like weird things just keep happening today…)</th>

<th>(Or I guess, it’s more like an odd feeling has been nagging my mind…)</th>
{% endbubble %}
...
{% bubble Mao %}
<th>(Transfer student? Is that about Anzu? …Huh? Who’s Anzu…?)</th>

<th>(No, no, wait. Anzu’s our *producer!* How could I forget who she was for a second there…)</th>

<th>(This just keeps happening… Something’s clouding my head, and it doesn’t feel right…)</th>
{% endbubble %}
...
{% img /img/es/scoutstory/mangaclub/1_4.jpg %}
...
{% img /img/es/scoutstory/mangaclub/2_1.jpg %}
...
{% img /img/es/scoutstory/mangaclub/2_2.jpg %}
...
{% bubble Tori %}
Yeah, that’s because I <em>am</em> from a rich household. Anyway, my family may have rejected investing in the event, but I’m personally interested in it. I was hoping to check it out.
{% endbubble %}
...
<div class="msr-narration">
    <p>Mao and Jun exchange glances in silence</p>
</div>
...
<th>(There’s action, comedy, sci-fi, sports, health, romance, social issues… Oh, even horror. There’s niche genres along with the popular ones, huh~)</th>

<th>(I’d like to be in an action manga… You can’t help but daydream about being in a shounen manga as a guy, so~ Ah, but a romcom sounds fun, too.)</th>

<th>(Mm, I really can’t decide… Which do I go for…?)</th>
{% endbubble %}
...
Erm, let’s just go with the romcom protagonist. *<th>(presses button)</th>*
...
{% bubble Mao %}
Nonono! It’s not like I <em>wanted</em> to involve you! I don’t even know why it turned out that way!
{% endbubble %}
...
{% bubble Eichi %}
……<em><th>(Laughing so much that no sound comes out)</th></em>
...
{% img /img/es/scoutstory/mangaclub/keitoorigcg.jpg %}
...
{% bubble Mao %}
Oh! Hasumi-senpai, you chose <em>that</em> manga?[^1] I love it, too! It’s really fun, right? It has all the popular tropes in the best way!
{% endbubble %}
...
{% bubble Tori %}
I can’t <em>believe</em> you’d wanna work your butt off in a dream world. I’d never go for that sort of thing.
...
{% bubble Mao %}
Why did everyone get to enjoy such a normal manga scenario when I got <em>that</em> for mine!?
{% endbubble %}
...
{% bubble Jun v3 %}
Yeah, those types of people know the dialogue by heart… Isn’t it more appropriate to make <em>actual</em> hardcore fans participate?
{% endbubble %}
...
{% bubble Mao %}
Yeah but, do <em>you</em> feel confident that you can win against quiz enthusiasts, Tori?
{% endbubble %}
...
{% bubble Eichi %}
I see… What a shame. Even though the winner can receive <em>such</em> a huge, grand prize…
