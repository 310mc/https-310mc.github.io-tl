...
{% bubble Midori v2 %}
I <em>just</em> said you’re being suffocating… Please quit hugging people over every little thing… You’re making things awkward for Anzu-san, too…
{% endbubble %}
...
{% bubble Chiaki surprised0 %}
Dwoph—!? W-What’re you doing all of a sudden!? <em>(Cough, cough)</em>… Don’t tackle someone as soon as you see them!
...
{% bubble Tetora %}
Woah, don’t stop now, Taishou! After crashing into him, you gotta straddle him! That’s how it goes…☆
{% endbubble %}
...
{% bubble Tetora %}
Ah, Midori-kun! And Anzu-Anego, too! ‘Suuup, I hope you’re doing well! Thanks for coming all the way here — You’re here to help guide Taishou, right!?
{% endbubble %}
...
{% bubble Tetora frown %}
Taishou~ Midori-kun’s pretty delicate, so you can’t pressure him like that!
{% endbubble %}
...
{% bubble Tetora nod %}
You don’t have to be so scared, Midori-kun~ Taishou’s real kind, trust me! ♪
{% endbubble %}
...
{% note narration %}
Translation In Progress! 4/11 Chapters
{% endnote %}
