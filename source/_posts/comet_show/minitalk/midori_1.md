...
<script src="https://cdn.jsdelivr.net/gh/enstars/tl-utils@1.2.32/tl-utils.min.js"></script>
...
<div class="minitalk" character="Anzu">
    <div class="minitalk-option">
        ...
        <div class="minitalk-option_content">
			...
			<div data-tab="1a-n">
            	{% bubble Midori %}
							Mhm, exactly. I keep finding myself complaining about how depressing it is…
	...
	<div class="minitalk-option">
        ...
        <div class="minitalk-option_content">
			...
			<div data-tab="1b-n">
            	{% bubble Midori %}
							I knew it. Well, 'course you would, since you're the producer…
        ...
        <div class="minitalk-option_content">
			...
			<div data-tab="1b-n">
            	{% bubble Midori %}
							...
							I guess Hinata-kun could be another option…? But I might end up bothering him if I suddenly come to him with a problem…
				{% endbubble %}
			</div>
			<div data-tab="1b-r" style="display: none">
            	{% bubble Midori %}
