...
{% note location %}
(Rinne is current live on stage, preparing himself to start dissing Ryuseitai on the Idol Royale.)
{% endnote %}
{% note location %}
...
No, wait—Forget Akehoshi-senpai right now, we need to talk about Crazy:B—
