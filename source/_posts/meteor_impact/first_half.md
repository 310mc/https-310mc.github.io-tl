---
title: "Meteor Impact - Two Years Ago: Not Quite A Hero"
...
## Story Details
**Chapter Title:** Meteor Impact - Two Years Ago: Not Quite A Hero
...
<th>(They ended up not only leaving burn marks, but also dirtying the place with leftover food, so the teachers are furious.)</th>
...
**ENG Proof:** [Shie](https://twitter.com/starIits), [Gold](https://twitter.com/goldgust)
...
<th>(Although apparently I would’ve still been accepted into the academy even if I’d never bothered to study…)</th>
...
<th>(There’s rumors that he’s the delinquent of the academy, after all…)</th>
...
{% endbubble %}
{% bubble ChiakiPast %}
Huh? Why do you look so confused!? Have you never caught a cold before? That means you’ve got a really good, healthy body! I’m jealous — I’ve always been prone to illnesses!
...
{% endbubble %}
{% bubble KanataPast kanatapast_frown %}
...
{% endbubble %}
{% bubble KuroPast injuredangrycg %}
...
{% bubble ChiakiPast worried worried %}
Shinkai-kun!
...
{% btn /meteor_impact/prologue,, arrow-left, Previous Chapter: Meteor Impact - Prologue %}{% btn /meteor_impact,, star, Index %}{% btn /meteor_impact/monologue,, arrow-right, Next Chapter: Meteor Impact - Monologue %}</div>
...
[^4]: This is a reference to the first [Kamen Rider](https://kamenrider.fandom.com/wiki/Kamen_Rider) series, where the first rider was called [Kamen Rider ichi-go](https://kamenrider.fandom.com/wiki/Takeshi_Hongo), and the second [Kamen Rider ni-go](https://kamenrider.fandom.com/wiki/Hayato_Ichimonji). The two poses Chiaki is referring to can be seen [here](https://twitter.com/ryuseitai_info/status/1123771801639825408). As extra info, even Chiaki’s 2* card is a reference to [Kamen Rider ichi-go’s pose](https://ensemble-stars.fandom.com/wiki/%28Academy_Idol%29_Chiaki_Morisawa).
[^5]: To worship in Japanese is *matsuru* (祭る), and is where the word *matsuri* (祭り) is derived from.
[^6]: The tale of [Yaobikuni](https://en.wikipedia.org/wiki/Ningyo), about a girl who ate mermaid meat, and went on to live for 800 years.
