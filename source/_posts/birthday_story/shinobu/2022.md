...
<div class="minitalk" character="Anzu">
    <div class="minitalk-option">
        ...
        <div class="minitalk-option_content">
            ...
            Ohh, you can attach it to your clothes through this pin… Thank you for the lovely present, Anzu-dono!
			{% endbubble %}
        </div>
    </div>
    <div class="minitalk-option">
        ...
        <div class="minitalk-option_content">
            {% bubble Shinobu v2 %}
            I see, so a teddy bear that has my name on it… How elaborate! This works as proof that I am the main lead of this party, correct?
...
<div class="minitalk" character="Anzu">
    ...
    <div class="minitalk-option">
        ...
        <div class="minitalk-option_content">
            {% bubble Shinobu v2 %}
            Hmhm, we *are* having a banquet after all, one must start with a cheers! You're correct as always, Anzu-dono.
...
<div class="minitalk" character="Anzu">
    ...
    <div class="minitalk-option">
        ...
        <div class="minitalk-option_content">
            {% bubble Shinobu v2 %}
            Hmm… Well, I feel as though we would have a lot of fun if everyone could be ninjas together, and show off their ninja art… However, I don't particularly have anything I want either way.
