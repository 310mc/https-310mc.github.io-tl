...
{% bubble Chiaki %}
Oh yeah, Anzu-san — Are you here to take -kun to his party?
{% endbubble %}
...
{% bubble Chiaki v2 %}
Then, what say you take a video for them, -kun?
{% endbubble %}
...
<div class="minitalk" character="Anzu">
    <div class="minitalk-option">
        ...
        <div class="minitalk-option_content">
            ...
            {% endbubble %}
            {% bubble Chiaki %}
            I won't force ya, but I'd love it if you did, -kun! C'mon, please? ♪
			{% endbubble %}
        </div>
    </div>
    <div class="minitalk-option">
